              ...
              <div class="box-body">
                ...
                <div class="row">
				  <div class="col-sm-12 col-sm-8 col-md-8">
                    ...
                    <select name="txtIdDepRef" id="txtIdDepRef" style="width:100%; height: 50px;" class="form-control"  onkeydown="campoSiguiente('txtNroRefDep', event);" disabled>
				  ...
				  <div class="form-group col-sm-4 col-md-4">
					<label for="txtNroAteManual"><small>Código NetLab <span class="text-danger">(*)</span>:</small></label>
					<input type="text" name="txtNroAteManual" id="txtNroAteManual" class="form-control input-lg" maxlength="10" value="" disabled/>
                  </div>
                  <div class="form-group col-sm-4 col-md-3">
                    ...
                    <select class="form-control input-lg" name="txtIdPlanTari" id="txtIdPlanTari" onkeydown="campoSiguiente('txtFechaAten', event);" disabled>
                      ...
                      foreach ($rsTa as $rowTa) {
                        echo "<option value='" . $rowTa['id_plan'] . "#" . $rowTa['check_precio'] . "'"; if($rowTa['id_plan'] . "#" . $rowTa['check_precio']=="3#f"){ echo " selected";} echo ">" . $rowTa['nom_plan'] . "</option>";
                      }
                      ?>
                    </select>
                  </div>
				  <div class="form-group col-sm-4">
                    <label for="txtFechaTomaMuestra">Fecha toma de muestra <span class="text-danger">(*)</span>:</label>
                    <div class="input-group input-group-lg">
                      <div class="input-group-addon" for="txtFechaTomaMuestra"><i class="fa fa-calendar" for="txtFechaTomaMuestra"></i></div>
                      <input type="text" name="txtFechaTomaMuestra" placeholder="DD/MM/AAAA" id="txtFechaTomaMuestra" autofocus="" class="form-control" maxlength="10" value="<?php echo date("d/m/Y") ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask onkeydown="campoSiguiente('txtFechaAten', event);" disabled/>
                    </div>
                  </div>
                  <div class="form-group col-sm-4">
                    <label for="txtFechaAten">Fecha recepción <span class="text-danger">(*)</span>:</label>
                    <div class="input-group input-group-lg">
                  ...
                  <div class="form-group col-sm-1">
                    <label for="txtNroRefAtencion"><small>Cnt. Rec.</label>
                    <input type="text" name="txtNroRefAtencion" id="txtNroRefAtencion" class="form-control input-lg" maxlength="2" disabled/>
                  </div>
				 </div>
				  ...
				  <div class="col-sm-8 col-md-9">
					<select class="form-control" name="txtIdProducto" id="txtIdProducto" style="width: 100%" disabled>
					  ...
					  foreach ($rsP as $rowP) {
						...
						echo "<option value='" . $rowP['id_producto'] . "#".$rowP['codref_producto']."#".$rowP['nomtipo_producto']."#".$rowP['prec_sis']."#".$rowP['prec_parti']."'>" . $examen . "</option>";
					  }
					  ?>
					</select>
				  </div>
				  <div class="col-sm-4 col-md-3">
					<button type="button" class="btn btn-lg pull-left btn-success" style="margin-bottom: 15px;" onclick="addRow('')"><i class="glyphicon glyphicon-plus"></i> Agregar</button>
				  </div>
				</div>
...
<script src="main_reglabref.js?v=<?php echo rand(); ?>"></script>
...
function habilita_atencionubi(){
  ...
  $('#txtNroAteManual').prop("disabled", false);
  $('#txtIdServicio').prop("disabled", false);
  $('#txtFechaTomaMuestra').prop("disabled", false);
...
function maxlength_doc_bus() {
  ...
  if ($("#txtIdTipDocPac").val() == "7") {
    ...
    setTimeout(function(){$('#txtPriApePac').trigger('focus');}, 2);
  } else {
    $("#txtNroDocPac").val('');
    $("#txtNroDocPac").prop("disabled", false);
    $("#btnPacSearch").prop("disabled", false);
...
$(document).ready(function() {
	...
	$('#txtFechaTomaMuestra').datetimepicker({
	locale: 'es',
	format: 'L'
	});
	$('#txtFechaTomaMuestra').inputmask();
