<div class="row">
	<?php 
		...
		if($cnt > 0){
	?>
<p><b>&nbsp;&nbsp;&nbsp;Leyenda de botones de acción</b>: <img src="../../assets/images/details_open.png"/>= Mostrar datos adicionales | <a href="#" class="acept" title="Editar"><i class="glyphicon glyphicon-pencil" style="color: #449d44;"></i></a>= Acción correctiva | <a href="#" class="detail" style="color: #00c0ef;"><i class="glyphicon glyphicon-eye-open"></i></a>= Visualizar detalle registro</a> | <a href="#" class="warning" style="color: #23527c;"><i class="glyphicon glyphicon-eye-open"></i></a>= Visualizar acción correctiva y detalle de registro</a></p>
