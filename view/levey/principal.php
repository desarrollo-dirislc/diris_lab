  ...
  <div class="panel-prime">
    ...
    <div class="panel-body">
		<div class="row">
			...
			<div class="col-sm-2">
				<br/>
				<button type="button" class="btn btn-warning" id="btn_expor_det" onclick="expor_datos('EESS')"><i class="glyphicon glyphicon-open"></i> Exportar datos </button>
			</div>
			<div class="col-sm-2">
				<br/>
				<button type="button" class="btn btn-success" id="btn_expor_det" onclick="expor_datos('TOT')"><i class="glyphicon glyphicon-open"></i> Exportar total </button>
			</div>
		</div>
		<hr/>
		  <div class="panel with-nav-tabs">
			<div class="panel-heading-tab">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab_p1" data-toggle="tab" aria-expanded="true"><b>HEMATOLOGIA</b></a></li>
						<li class=""><a href="#tab_p2" data-toggle="tab" aria-expanded="true"><b>BIOQUIMICA</b></a></li>
					</ul>
			</div>
			<div class="panel-body">				
				<div class="tab-content">
					<div class="tab-pane active" id="tab_p1">
						<div class="panel with-nav-tabs panel-success">
							<div class="panel-heading">
									<ul class="nav nav-tabs">
										<li class="active"><a href="#tab_h1" data-toggle="tab" aria-expanded="true">HEMOGLOBINA</a></li>
										<li class=""><a href="#tab_h2" data-toggle="tab" aria-expanded="false">HEMATOCRITO</a></li>
										<li class=""><a href="#tab_h3" data-toggle="tab" aria-expanded="false">GLOBULOS BLANCOS</a></li>
										<li class=""><a href="#tab_h4" data-toggle="tab" aria-expanded="false">PLAQUETAS</a></li>
									</ul>
							</div>
							<div class="panel-body">
								<div class="tab-content">
									<div class="tab-pane active" id="tab_h1">
										<?php include "principal_hemoglobina.php" ?>
									</div>
									<div class="tab-pane" id="tab_h2">
										<?php include "principal_hematocrito.php" ?>
									</div>
									<div class="tab-pane" id="tab_h3">
										<?php include "principal_glubuloblanco.php" ?>
									</div>
									<div class="tab-pane" id="tab_h4">
										<?php include "principal_plaqueta.php" ?>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="panel with-nav-tabs panel-primary">
							<div class="panel-heading">
									<ul class="nav nav-tabs">
										...
										<li class=""><a href="#tab_16" data-toggle="tab" aria-expanded="false">GAMMA GLUTAMIL TRANSPEPTIDASA - GGT</a></li>
										<li class=""><a href="#tab_17" data-toggle="tab" aria-expanded="false">MICROALBUMINURIA</a></li>
									</ul>
							</div>
							<div class="panel-body">
								<div class="tab-content">
									...
									<div class="tab-pane" id="tab_16">
										<?php include "principal_ggt.php" ?>
									</div>
									<div class="tab-pane" id="tab_17">
										<?php include "principal_microalbuminuria.php" ?>
									</div>
								</div>
							</div>
						</div>
